...
interface HomeItemIconProp {
  iconcolor: keyof typeof ICON_COLOR;
}

export const HomeItemIcon = styled.p<HomeItemIconProp>`
  display: flex;
  align-items: center;
  gap: 0.75rem;
  ...
  span {
    ...
    height: 2rem;
    border-radius: 50%;
    background: ${(props) => props.theme.color[ICON_COLOR[props.iconcolor]]};
...
export const HomeCoffeRow = styled.div`
  display: flex;
  flex-direction: row;
